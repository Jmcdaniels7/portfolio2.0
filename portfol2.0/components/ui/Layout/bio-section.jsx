...
export const SkeletonOne = () => {
  return (
    <div className="relative flex gap-10">
      <div
        className="mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
...
export const SkeletonThree = () => {
  return (
    <a
      ...
      <div
        className="mx-auto bg-transparent dark:bg-transparent group h-full">
...
export const SkeletonFour = () => {
  return (
    <div
      className="h-10 md:h-10  flex flex-col items-center relative bg-transparent dark:bg-transparent mt-10">
